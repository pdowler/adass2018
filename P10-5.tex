...
\affil{$^1$Canadian Astronomy Data Centre, National Research Council Canada, Victoria, British Columbia, Canada}
\affil{$^2$ESAC Science Data Centre, Villanueva de la Ca'nada, Madrid, Spain}
\affil{$^3$Space Telescope Science Institute, Baltimore, Maryland, United States of America}

\paperauthor{Patrick~Dowler}{patrick.dowler@nrc-cnrc.gc.ca}{https://orcid.org/0000-0001-7011-4589}{Canadian Astronomy Data Centre}{National Research Council Canada}{Victoria}{British Columbia}{V9E 2E7}{Canada}

\paperauthor{Maria~Arevalo}{maria.arevalo@sciops.esa.int}{}{ESAC}{ESAC Science Data Centre}{Villanueva de la Ca'nada}{Madrid}{28691}{Spain}

\paperauthor{Adrian~Damian}{adrian.damian@nrc-cnrc.gc.ca}{}{Canadian Astronomy Data Centre}{National Research Council Canada}{Victoria}{British Columbia}{V9E 2E7}{Canada}

\paperauthor{Javier~Duran}{javier.duran@sciops.esa.int}{}{ESAC}{ESAC Science Data Centre}{Villanueva de la Ca'nada}{Madrid}{28691}{Spain}

\paperauthor{Daniel~Durand}{daniel.durand@nrc-cnrc.gc.ca}{}{Canadian Astronomy Data Centre}{National Research Council Canada}{Victoria}{British Columbia}{V9E 2E7}{Canada}

\paperauthor{Severin~Gaudet}{severin.gaudet@nrc-cnrc.gc.ca}{http://orcid.org/0000-0001-9281-2361}{Canadian Astronomy Data Centre}{National Research Council Canada}{Victoria}{British Columbia}{V9E 2E7}{Canada}
...
\paperauthor{Brian~Major}{brian.major@nrc-cnrc.gc.ca}{http://orcid.org/0000-0001-9263-3048}{Canadian Astronomy Data Centre}{National Research Council Canada}{Victoria}{British Columbia}{V9E 2E7}{Canada}
...
Polygon validity (used to describe the spatial coverage of an observation) was restricted to be consistent with IVOA DALI \citep{std:DALI11} polygon (simple polygon with counterclockwise winding direction). The previous polymorphic shape and general polygon with disjoint parts was retained to provide a more detailed footprint when necessary.
...
CADC provides IVOA services (TAP, SIA \citep{std:SIAv2}, DataLink \citep{std:DataLink}, SODA \citep{std:SODA}) and IVOA ObsCore data model support as part of their programmatic archive data discovery services. ESAC also provides IVOA services (TAP, SIA, SSA \citep{std:SSAP}) based on the HST metadata in their CAOM database.
